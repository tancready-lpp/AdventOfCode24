...
# --- Brute Force Approach --- Computational time = 1.9s
# I'm going to use for loops and check each number

counts = {} # empty dictionary containing "number" = repeting count 
...
animals= {"lion":"The lion ins a mighty feline", "crocodile":"The Crocodile is a fierce and scary ancient animal"}
